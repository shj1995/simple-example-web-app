...
import { SFDLSSize } from '@delon/form/src/schema/ui';
import { TemplateRef } from '@angular/core';
import { NzOptionComponent } from 'ng-zorro-antd/select';
import { NzSafeAny } from 'ng-zorro-antd/core/types';

export interface DMEntitySelectWidgetSchema {
  /**
   * 下拉菜单的 EntityTypeId 属性
   */
  source?: string;
  /**
   * 下拉菜单的 className 属性
   ...
   */
  change?: (ngModel: SFValue | SFValue[], orgData: SFSchemaEnum | SFSchemaEnum[], formUISchema: any) => void;
